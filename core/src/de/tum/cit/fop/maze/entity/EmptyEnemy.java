...
public class EmptyEnemy implements Entity {
    ...
    public EmptyEnemy(float x, float y,Player player,HUD hud,SoundManager soundManager, Map<String, Animation<TextureRegion>> animations) {

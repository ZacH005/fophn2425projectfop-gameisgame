...
public class MeleeEnemy extends Enemy {
    public MeleeEnemy(float x, float y, Player player, HUD hud, SoundManager soundManager, Map<String, Animation<TextureRegion>> animations) {
        super(x, y, player, hud, soundManager, animations);
    }
